...
public class WriteMultipleRegistersResponse : ModbusBaseResponse
{
    public WriteMultipleRegistersResponse(WriteMultipleRegistersRequest request, ArraySegment<byte> frameData, DeviceEndianess endianess) : base(request, frameData, endianess)
    {
